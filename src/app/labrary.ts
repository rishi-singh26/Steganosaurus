...
export function SimplePixel(simple_image: any, x: any, y: any) {
    ...
    __init: function (img) {
      try {
        ...
        if (img instanceof HTMLCanvasElement) {
          var canvasData = img.getContext("2d")
